...
%     countries = shaperead('world_borders','UseGeoCoords', true);
    countries = shaperead('/Users/samrabin/Geodata/General/countriesEtc_NaturalEarth/ne_110m_admin_0_countries_lakes/ne_110m_admin_0_countries_lakes.shp','UseGeoCoords', true);
end
...
% cptcmap('/Users/samrabin/Documents/Dropbox/Dissertation/MATLAB work/Brian_example_PlotGeographicMap/cptfiles/ssr.BF_colormap.cpt',...
%         'ncol',length(BF_binEdges)-1);%,...
        %'mapping','direct') ;
cptcmap('/Users/samrabin/Documents/Dropbox/Dissertation/MATLAB work/Brian_example_PlotGeographicMap/cptfiles/ssr.BF_colormap.indices.cpt',...
        'ncol',length(BF_binEdges)-1);%,...
        %'mapping','direct') ;
