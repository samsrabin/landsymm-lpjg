    ...
    for PLUMcrop in PLUMcrops:
        ...
        if PLUM2GGCMI_dict[PLUMcrop] == "max_wheat":
            ...
            tw, missing_climate = try_load_climate(
                climate_dir, "tas", GGCM, GGCMIcrop_tmp, rcp, missing_climate
            )
            ww, missing_climate = try_load_climate(
                climate_dir, "pr", GGCM, GGCMIcrop_tmp, rcp, missing_climate
            )
            ...
            t, missing_climate = try_load_climate(
                climate_dir, "tas", GGCM, GGCMIcrop, rcp, missing_climate
            )
            w, missing_climate = try_load_climate(
                climate_dir, "pr", GGCM, GGCMIcrop, rcp, missing_climate
            )
