...
% See previous notes for remap_v6p3, with the following changes:
% - Fixed assignment of Nfert to correct index for ExtraCrop
% - Now using correct manure data.
...
out_dir = '/Users/Shared/PLUM/input/remaps_v6p6/' ;
...
out_file_lu = [out_dir 'LU.remapv6p6.txt'] ;
out_file_cropfrac = [out_dir 'cropfracs.remapv6p6.txt'] ;
out_file_nfert = [out_dir 'nfert.remapv6p6.txt'] ;
