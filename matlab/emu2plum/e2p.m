...
topDir_phase2 = '/Users/Shared/GGCMI/AgMIP.output/LPJmL/phase2' ;
...
topDir_emu_bl = '/Users/Shared/GGCMI2PLUM_sh/emulation/outputs/outputs_GGCMIcropsBaseline_20191008' ;
topDir_emu_fu = '/Users/Shared/GGCMI2PLUM_sh/emulation/outputs/outputs_GGCMIcrops_20191008' ;
outDir = '/Users/Shared/GGCMI2PLUM_sh/send_to_plum/emulator_test_20191106' ;
...
data_fu_lpj = e2p_import_fu_lpj(baseline_yN, future_ts, future_yN, topDir_lpj, ...
...
if contains(which_file, {'yield','gsirrigation'}) && (excl_lowBL_agmerra || excl_lowBL_emu)
    ...
    elseif strcmp(which_file, 'gsirrigation')
        ...
        exclude_xc_file = sprintf('%s/exclude_xc.mat', outDir) ;
...
% Save exclusion info
out_file = sprintf('%s/exclude_xc.mat', outDir) ;
...
if strcmp(which_file, 'yield')
    out_file = sprintf('%s/is_ww_max.mat', outDir) ;
