...
out_dir = '/Users/Shared/PLUM/input/remaps_v5c/' ;
...
out_file_lu = [out_dir 'LU.remapv5c.' thisVer '.ecFertIrr0.setaside' strrep(num2str(PLUMsetAside_frac),'.','') '.m' num2str(inpaint_method) '.txt'] ;
out_file_cropfrac = [out_dir 'cropfracs.remapv5c.' thisVer allRF_txt '.ecFertIrr0.setaside' strrep(num2str(PLUMsetAside_frac),'.','') '.m' num2str(inpaint_method) '.txt'] ;
out_file_nfert = [out_dir 'nfert.remapv5c.' thisVer allRF_txt '.ecFertIrr0.setaside' strrep(num2str(PLUMsetAside_frac),'.','') '.m' num2str(inpaint_method) '.txt'] ;
