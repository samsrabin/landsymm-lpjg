...
out_dir = '/Users/Shared/PLUM/input/remaps_v6/' ;
...
out_file_lu = [out_dir 'LU.remapv6.txt'] ;
out_file_cropfrac = [out_dir 'cropfracs.remapv6.txt'] ;
out_file_nfert = [out_dir 'nfert.remapv6.txt'] ;
