...
%   area of that crop.
% - Only including a part of the world, since I'm only intending this as a
%   test to see what kind of difference that change makes.
% - Saves gridlist for just that part of the world.
...
gridlist.mask_YX(:,[1:549 651:720]) = false ;
gridlist.mask_YX([1:199 301:360],:) = false ;
...
out_file_lu = [out_dir 'LU.remapv6p2.txt'] ;
out_file_cropfrac = [out_dir 'cropfracs.remapv6p2.txt'] ;
out_file_nfert = [out_dir 'nfert.remapv6p2.txt'] ;
