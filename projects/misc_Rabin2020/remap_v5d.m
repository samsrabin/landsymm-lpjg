...
%%%%% Sam Rabin, 2019-02-05
% See previous notes for remap_v5c, with the following changes:
...
out_dir = '/Users/Shared/PLUM/input/remaps_v5d/' ;
...
out_file_lu = [out_dir 'LU.remapv5d.' thisVer '.ecFertIrr0.setaside' strrep(num2str(PLUMsetAside_frac),'.','') '.m' num2str(inpaint_method) '.txt'] ;
out_file_cropfrac = [out_dir 'cropfracs.remapv5d.' thisVer allRF_txt '.ecFertIrr0.setaside' strrep(num2str(PLUMsetAside_frac),'.','') '.m' num2str(inpaint_method) '.txt'] ;
out_file_nfert = [out_dir 'nfert.remapv5d.' thisVer allRF_txt '.ecFertIrr0.setaside' strrep(num2str(PLUMsetAside_frac),'.','') '.m' num2str(inpaint_method) '.txt'] ;
