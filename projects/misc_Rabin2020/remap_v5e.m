...
%%%%% Sam Rabin, 2019-02-17
% See previous notes for remap_v5e, with the following changes:
...
out_dir = '/Users/Shared/PLUM/input/remaps_v5e/' ;
...
out_file_lu = [out_dir 'LU.remapv5e.txt'] ;
out_file_cropfrac = [out_dir 'cropfracs.remapv5e.txt'] ;
out_file_nfert = [out_dir 'nfert.remapv5e.txt'] ;
