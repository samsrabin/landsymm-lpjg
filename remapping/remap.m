...
%     files_soil: Path (char) or list of paths (cell array of chars) to LPJ-GUESS soil
%                 file(s) to be interpolated to match file_gridlist_out.
...
for f = 1:length(files_soil)
    ...
    isbad_YX = remap_map_missing(soil.garr_xv, gridlist, ['soil_' soil_filename], out_dir_figs) ;
