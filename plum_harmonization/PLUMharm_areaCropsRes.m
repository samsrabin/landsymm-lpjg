...
%             disp(['*y0* from ' file_in])
            load(file_in) ;
            if exist('out_y0_nfert_2deg','var')
                out_y0_2deg_nfert = out_y0_nfert_2deg ;
                clear out_y0_nfert_2deg
            end
            if exist('out_y0_irrig_2deg','var')
                out_y0_2deg_irrig = out_y0_irrig_2deg ;
                clear out_y0_irrig_2deg
            end
        end
...
%         fprintf('in_%d glob Nfert (Mt): %0.3f\n', thisYear,   tmp1)
%         fprintf('            diff (Mt): %0.3f\n\n', tmp1-tmp0)
%         tmp0 = 1e-6*1e-3*sum(sum(out_y0_2deg_agri_YXv(:,:,2) .* out_y0_2deg_nfert.maps_YXv(:,:,2))) ;
...
%         fprintf('              diff (Mt): %0.3f\n\n', tmp1-tmp0)
        PLUMharm_check_conservation(...
            out_y0_2deg_nfert.maps_YXv, out_y0_2deg_agri_YXv(:,:,~strcmp(LUnames_agri,'PASTURE')), ...
            ...
            '2b nfert') ;
        PLUMharm_check_conservation(...
            out_y0_2deg_irrig.maps_YXv, out_y0_2deg_agri_YXv(:,:,~strcmp(LUnames_agri,'PASTURE')), ...
        ...
        [out_y1_2deg_nfert_YXv, total_unmet2_nfert_YXv] = PLUMharm_ringRedist_mgmt(...
            ...
            LPJGcrops, [], ...
            out_y0_2deg_nfert, out_y0_2deg_agri_YXv(:,:,~strcmp(LUnames_agri,'PASTURE')), ...
            ...
            conserv_tol_pct, ...
            'ringRedist nfert') ;
%         tmp0 = 1e-6*1e-3*sum(sum(out_y0_2deg.maps_YXv(:,:,2) .* out_y0_2deg_nfert.maps_YXv(:,:,2))) ;
...
%         fprintf('              diff (Mt): %0.3f\n\n', tmp1-tmp0)
        ...
        [out_y1_2deg_irrig_YXv, total_unmet2_irrig_YXv] = PLUMharm_ringRedist_mgmt(...
            ...
            LPJGcrops, [], ...
            out_y0_2deg_irrig, out_y0_2deg_agri_YXv(:,:,~strcmp(LUnames_agri,'PASTURE')), ...
